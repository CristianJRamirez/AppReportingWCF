...
public class VectorVehiculoConstruccion extends Vector<VehiculoConstruccion> implements KvmSerializable {
    
    
    public VectorVehiculoConstruccion(){}
    
    public VectorVehiculoConstruccion(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    VehiculoConstruccion j1= new VehiculoConstruccion(j0);
                    add(j1);
                }
            }
        }
