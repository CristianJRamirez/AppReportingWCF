...
public class VectorCuentaContable extends Vector<CuentaContable> implements KvmSerializable {
    
    
    public VectorCuentaContable(){}
    
    public VectorCuentaContable(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    CuentaContable j1= new CuentaContable(j0);
                    add(j1);
                }
            }
        }
