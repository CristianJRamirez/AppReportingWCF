...
public class VectorGrupoServicio extends Vector<GrupoServicio> implements KvmSerializable {
    
    
    public VectorGrupoServicio(){}
    
    public VectorGrupoServicio(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    GrupoServicio j1= new GrupoServicio(j0);
                    add(j1);
                }
            }
        }
