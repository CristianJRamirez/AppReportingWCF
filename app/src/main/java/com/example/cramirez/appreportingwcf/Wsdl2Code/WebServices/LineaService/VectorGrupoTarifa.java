...
public class VectorGrupoTarifa extends Vector<GrupoTarifa> implements KvmSerializable {
    
    
    public VectorGrupoTarifa(){}
    
    public VectorGrupoTarifa(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    GrupoTarifa j1= new GrupoTarifa(j0);
                    add(j1);
                }
            }
        }
