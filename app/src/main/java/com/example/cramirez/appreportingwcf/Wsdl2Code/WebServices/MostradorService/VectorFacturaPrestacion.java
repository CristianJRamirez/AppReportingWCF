...
public class VectorFacturaPrestacion extends Vector<FacturaPrestacion> implements KvmSerializable {
    
    
    public VectorFacturaPrestacion(){}
    
    public VectorFacturaPrestacion(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    FacturaPrestacion j1= new FacturaPrestacion(j0);
                    add(j1);
                }
            }
        }
