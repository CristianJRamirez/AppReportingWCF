...
public class VectorTipoGrupoServicio extends Vector<TipoGrupoServicio> implements KvmSerializable {
    
    
    public VectorTipoGrupoServicio(){}
    
    public VectorTipoGrupoServicio(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    TipoGrupoServicio j1= new TipoGrupoServicio(j0);
                    add(j1);
                }
            }
        }
