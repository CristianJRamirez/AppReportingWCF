...
public class VectorFactura extends Vector<Factura> implements KvmSerializable {
    
    
    public VectorFactura(){}
    
    public VectorFactura(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
