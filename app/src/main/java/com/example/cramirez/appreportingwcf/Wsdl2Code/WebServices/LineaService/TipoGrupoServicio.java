...
public class TipoGrupoServicio implements KvmSerializable {
    ...
    public long idTipoGrupoServicio;
    public boolean idTipoGrupoServicioSpecified;
    ...
    public TipoGrupoServicio(){}
    
    public TipoGrupoServicio(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("IdTipoGrupoServicio"))
        {
            Object obj = soapObject.getProperty("IdTipoGrupoServicio");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                idTipoGrupoServicio = Integer.parseInt(j.toString());
            }else if (obj!= null && obj instanceof Number){
                idTipoGrupoServicio = (Integer) obj;
            }
        }
        if (soapObject.hasProperty("IdTipoGrupoServicioSpecified"))
        {
            Object obj = soapObject.getProperty("IdTipoGrupoServicioSpecified");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                idTipoGrupoServicioSpecified = Boolean.parseBoolean(j.toString());
            }else if (obj!= null && obj instanceof Boolean){
                idTipoGrupoServicioSpecified = (Boolean) obj;
            }
        }
    ...
    public Object getProperty(int arg0) {
        switch(arg0){
            ...
            case 9:
                return idTipoGrupoServicio;
            case 10:
                return idTipoGrupoServicioSpecified;
            case 11:
                return publicado;
            case 12:
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        switch(index){
            ...
            case 9:
                info.type = Long.class;
                info.name = "IdTipoGrupoServicio";
                break;
            case 10:
                info.type = PropertyInfo.BOOLEAN_CLASS;
                info.name = "IdTipoGrupoServicioSpecified";
                break;
            case 11:
                info.type = PropertyInfo.BOOLEAN_CLASS;
                info.name = "Publicado";
