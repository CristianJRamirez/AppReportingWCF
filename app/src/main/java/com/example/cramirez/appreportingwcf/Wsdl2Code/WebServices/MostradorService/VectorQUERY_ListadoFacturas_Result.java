...
public class VectorQUERY_ListadoFacturas_Result extends Vector<QUERY_ListadoFacturas_Result> implements KvmSerializable {
    ...
    public VectorQUERY_ListadoFacturas_Result(){}
    
    public VectorQUERY_ListadoFacturas_Result(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    QUERY_ListadoFacturas_Result j1= new QUERY_ListadoFacturas_Result(j0);
                    add(j1);
                }
            }
        }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        info.name = "QUERY_ListadoFacturas_Result";
