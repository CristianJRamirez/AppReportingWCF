...
public class VectorQuery_ImpresionTIT_Solicitud_Result extends Vector<Query_ImpresionTIT_Solicitud_Result> implements KvmSerializable {
    ...
    public VectorQuery_ImpresionTIT_Solicitud_Result(){}
    
    public VectorQuery_ImpresionTIT_Solicitud_Result(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    Query_ImpresionTIT_Solicitud_Result j1= new Query_ImpresionTIT_Solicitud_Result(j0);
                    add(j1);
                }
            }
        }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        info.name = "Query_ImpresionTIT_Solicitud_Result";
