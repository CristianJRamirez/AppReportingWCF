...
public class GrupoCentro implements KvmSerializable {
    ...
    public long idGrupoCentro;
    public boolean idGrupoCentroSpecified;
    ...
    public GrupoCentro(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("IdGrupoCentro"))
        {
            Object obj = soapObject.getProperty("IdGrupoCentro");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                idGrupoCentro = Integer.parseInt(j.toString());
            }else if (obj!= null && obj instanceof Number){
                idGrupoCentro = (Integer) obj;
            }
        }
        if (soapObject.hasProperty("IdGrupoCentroSpecified"))
        {
            Object obj = soapObject.getProperty("IdGrupoCentroSpecified");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                idGrupoCentroSpecified = Boolean.parseBoolean(j.toString());
            }else if (obj!= null && obj instanceof Boolean){
                idGrupoCentroSpecified = (Boolean) obj;
            }
        }
    ...
    public Object getProperty(int arg0) {
        switch(arg0){
            ...
            case 9:
                return grupoRecargo;
            case 10:
                return idGrupoCentro;
            case 11:
                return idGrupoCentroSpecified;
            case 12:
                return publicado;
            case 13:
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        switch(index){
            ...
            case 10:
                info.type = Long.class;
                info.name = "IdGrupoCentro";
                break;
            case 11:
                info.type = PropertyInfo.BOOLEAN_CLASS;
                info.name = "IdGrupoCentroSpecified";
                break;
            case 12:
                info.type = PropertyInfo.BOOLEAN_CLASS;
                info.name = "Publicado";
