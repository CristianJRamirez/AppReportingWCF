...
public class QUERY_ArqueoCajaClientesHabituales_Result implements KvmSerializable {
    ...
    public QUERY_ArqueoCajaClientesHabituales_Result(){}
    
    public QUERY_ArqueoCajaClientesHabituales_Result(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
