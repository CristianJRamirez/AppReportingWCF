...
public class Query_ImpresionTIT_Solicitud_Result implements KvmSerializable {
    ...
    public Query_ImpresionTIT_Solicitud_Result(){}
    
    public Query_ImpresionTIT_Solicitud_Result(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
