...
public class VectorQuery_InspeccionesVehiculo_Result extends Vector<Query_InspeccionesVehiculo_Result> implements KvmSerializable {
    ...
    public VectorQuery_InspeccionesVehiculo_Result(){}
    
    public VectorQuery_InspeccionesVehiculo_Result(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    Query_InspeccionesVehiculo_Result j1= new Query_InspeccionesVehiculo_Result(j0);
                    add(j1);
                }
            }
        }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        info.name = "Query_InspeccionesVehiculo_Result";
