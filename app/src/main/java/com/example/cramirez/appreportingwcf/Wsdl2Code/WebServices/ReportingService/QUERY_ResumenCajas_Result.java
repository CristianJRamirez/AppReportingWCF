...
public class QUERY_ResumenCajas_Result implements KvmSerializable {
    ...
    public QUERY_ResumenCajas_Result(){}
    
    public QUERY_ResumenCajas_Result(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
