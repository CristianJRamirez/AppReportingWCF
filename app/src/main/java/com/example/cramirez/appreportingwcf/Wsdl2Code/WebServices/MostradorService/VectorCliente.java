...
public class VectorCliente extends Vector<Cliente> implements KvmSerializable {
    
    
    public VectorCliente(){}
    
    public VectorCliente(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
