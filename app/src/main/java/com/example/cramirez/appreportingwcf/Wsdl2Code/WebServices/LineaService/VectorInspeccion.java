...
public class VectorInspeccion extends Vector<Inspeccion> implements KvmSerializable {
    
    
    public VectorInspeccion(){}
    
    public VectorInspeccion(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    Inspeccion j1= new Inspeccion(j0);
                    add(j1);
                }
            }
        }
