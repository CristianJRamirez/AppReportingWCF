...
public class VectorDefecto extends Vector<Defecto> implements KvmSerializable {
    
    
    public VectorDefecto(){}
    
    public VectorDefecto(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
