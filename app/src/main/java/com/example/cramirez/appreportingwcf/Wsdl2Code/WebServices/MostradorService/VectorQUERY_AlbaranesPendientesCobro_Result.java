...
public class VectorQUERY_AlbaranesPendientesCobro_Result extends Vector<QUERY_AlbaranesPendientesCobro_Result> implements KvmSerializable {
    ...
    public VectorQUERY_AlbaranesPendientesCobro_Result(){}
    
    public VectorQUERY_AlbaranesPendientesCobro_Result(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    QUERY_AlbaranesPendientesCobro_Result j1= new QUERY_AlbaranesPendientesCobro_Result(j0);
                    add(j1);
                }
            }
        }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        info.name = "QUERY_AlbaranesPendientesCobro_Result";
