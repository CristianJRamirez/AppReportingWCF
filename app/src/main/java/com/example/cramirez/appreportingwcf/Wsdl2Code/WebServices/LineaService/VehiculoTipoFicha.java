...
public class VehiculoTipoFicha implements KvmSerializable {
    ...
    public long idVehiculoTipoFicha;
    public boolean idVehiculoTipoFichaSpecified;
    ...
    public VehiculoTipoFicha(){}
    
    public VehiculoTipoFicha(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("IdVehiculoTipoFicha"))
        {
            Object obj = soapObject.getProperty("IdVehiculoTipoFicha");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                idVehiculoTipoFicha = Integer.parseInt(j.toString());
            }else if (obj!= null && obj instanceof Number){
                idVehiculoTipoFicha = (Integer) obj;
            }
        }
        if (soapObject.hasProperty("IdVehiculoTipoFichaSpecified"))
        {
            Object obj = soapObject.getProperty("IdVehiculoTipoFichaSpecified");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                idVehiculoTipoFichaSpecified = Boolean.parseBoolean(j.toString());
            }else if (obj!= null && obj instanceof Boolean){
                idVehiculoTipoFichaSpecified = (Boolean) obj;
            }
        }
    ...
    public Object getProperty(int arg0) {
        switch(arg0){
            ...
            case 5:
                return idVehiculoTipoFicha;
            case 6:
                return idVehiculoTipoFichaSpecified;
            case 7:
                return publicado;
            case 8:
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        switch(index){
            ...
            case 5:
                info.type = Long.class;
                info.name = "IdVehiculoTipoFicha";
                break;
            case 6:
                info.type = PropertyInfo.BOOLEAN_CLASS;
                info.name = "IdVehiculoTipoFichaSpecified";
                break;
            case 7:
                info.type = PropertyInfo.BOOLEAN_CLASS;
                info.name = "Publicado";
