...
public class QUERY_DefectologiaEstacionSPC_Result implements KvmSerializable {
    ...
    public QUERY_DefectologiaEstacionSPC_Result(){}
    
    public QUERY_DefectologiaEstacionSPC_Result(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
