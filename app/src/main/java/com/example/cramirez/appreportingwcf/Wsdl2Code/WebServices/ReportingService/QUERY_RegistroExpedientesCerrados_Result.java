...
public class QUERY_RegistroExpedientesCerrados_Result implements KvmSerializable {
    ...
    public QUERY_RegistroExpedientesCerrados_Result(){}
    
    public QUERY_RegistroExpedientesCerrados_Result(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
