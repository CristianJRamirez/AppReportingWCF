...
public class QUERY_ArqueoCajaResumido_Result implements KvmSerializable {
    ...
    public QUERY_ArqueoCajaResumido_Result(){}
    
    public QUERY_ArqueoCajaResumido_Result(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
