...
//
import package com.example.cramirez.appreportingwcf.Wsdl2Code.WebServices.MostradorService.WS_Enums.*;
...
public class MostradorService {
    ...
    public void RegistrarLogAsync(long idUsuario,boolean idUsuarioSpecified,LogTramaeTipoLog tipo,boolean tipoSpecified,String tabla,String proceso,String mensaje,long idClaveDato,boolean idClaveDatoSpecified) throws Exception{
        if (this.eventHandler == null)
            throw new Exception("Async Methods Requires IWsdl2CodeEvents");
    ...
    public void RegistrarLogAsync(final long idUsuario,final boolean idUsuarioSpecified,final LogTramaeTipoLog tipo,final boolean tipoSpecified,final String tabla,final String proceso,final String mensaje,final long idClaveDato,final boolean idClaveDatoSpecified,final List<HeaderProperty> headers) throws Exception{
    ...
    public void RegistrarLog(long idUsuario,boolean idUsuarioSpecified,LogTramaeTipoLog tipo,boolean tipoSpecified,String tabla,String proceso,String mensaje,long idClaveDato,boolean idClaveDatoSpecified){
        RegistrarLog(idUsuario, idUsuarioSpecified, tipo, tipoSpecified, tabla, proceso, mensaje, idClaveDato, idClaveDatoSpecified, null);
    }
    
    public void RegistrarLog(long idUsuario,boolean idUsuarioSpecified,LogTramaeTipoLog tipo,boolean tipoSpecified,String tabla,String proceso,String mensaje,long idClaveDato,boolean idClaveDatoSpecified,List<HeaderProperty> headers){
        SoapSerializationEnvelope soapEnvelope = new SoapSerializationEnvelope(SoapEnvelope.VER11);
        soapEnvelope.implicitTypes = true;
        soapEnvelope.dotNet = true;
    ...
    public void GenerarNumeroFacturaAsync(String codigoNumericoCentro,eCodigoCertio tipo,boolean tipoSpecified,boolean facturaAlbaran,boolean facturaAlbaranSpecified) throws Exception{
        if (this.eventHandler == null)
            throw new Exception("Async Methods Requires IWsdl2CodeEvents");
        GenerarNumeroFacturaAsync(codigoNumericoCentro, tipo, tipoSpecified, facturaAlbaran, facturaAlbaranSpecified, null);
    }
    
    public void GenerarNumeroFacturaAsync(final String codigoNumericoCentro,final eCodigoCertio tipo,final boolean tipoSpecified,final boolean facturaAlbaran,final boolean facturaAlbaranSpecified,final List<HeaderProperty> headers) throws Exception{
    ...
    public String GenerarNumeroFactura(String codigoNumericoCentro,eCodigoCertio tipo,boolean tipoSpecified,boolean facturaAlbaran,boolean facturaAlbaranSpecified){
        return GenerarNumeroFactura(codigoNumericoCentro, tipo, tipoSpecified, facturaAlbaran, facturaAlbaranSpecified, null);
    }
    
    public String GenerarNumeroFactura(String codigoNumericoCentro,eCodigoCertio tipo,boolean tipoSpecified,boolean facturaAlbaran,boolean facturaAlbaranSpecified,List<HeaderProperty> headers){
        SoapSerializationEnvelope soapEnvelope = new SoapSerializationEnvelope(SoapEnvelope.VER11);
        soapEnvelope.implicitTypes = true;
        soapEnvelope.dotNet = true;
