...
public class Banco implements KvmSerializable {
    ...
    public long idBanco;
    public boolean idBancoSpecified;
    ...
    public Banco(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("IdBanco"))
        {
            Object obj = soapObject.getProperty("IdBanco");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                idBanco = Integer.parseInt(j.toString());
            }else if (obj!= null && obj instanceof Number){
                idBanco = (Integer) obj;
            }
        }
        if (soapObject.hasProperty("IdBancoSpecified"))
        {
            Object obj = soapObject.getProperty("IdBancoSpecified");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                idBancoSpecified = Boolean.parseBoolean(j.toString());
            }else if (obj!= null && obj instanceof Boolean){
                idBancoSpecified = (Boolean) obj;
            }
        }
