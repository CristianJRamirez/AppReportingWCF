...
public class VectorGrupoRecargo extends Vector<GrupoRecargo> implements KvmSerializable {
    
    
    public VectorGrupoRecargo(){}
    
    public VectorGrupoRecargo(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    GrupoRecargo j1= new GrupoRecargo(j0);
                    add(j1);
                }
            }
        }
