...
public class VectorTipoInspeccion extends Vector<TipoInspeccion> implements KvmSerializable {
    
    
    public VectorTipoInspeccion(){}
    
    public VectorTipoInspeccion(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    TipoInspeccion j1= new TipoInspeccion(j0);
                    add(j1);
                }
            }
        }
