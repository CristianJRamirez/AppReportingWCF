...
public class VectorVehiculoUtilizacion extends Vector<VehiculoUtilizacion> implements KvmSerializable {
    
    
    public VectorVehiculoUtilizacion(){}
    
    public VectorVehiculoUtilizacion(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    VehiculoUtilizacion j1= new VehiculoUtilizacion(j0);
                    add(j1);
                }
            }
        }
