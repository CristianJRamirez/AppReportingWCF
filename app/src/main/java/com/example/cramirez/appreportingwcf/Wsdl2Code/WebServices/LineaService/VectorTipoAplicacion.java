...
public class VectorTipoAplicacion extends Vector<TipoAplicacion> implements KvmSerializable {
    
    
    public VectorTipoAplicacion(){}
    
    public VectorTipoAplicacion(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    TipoAplicacion j1= new TipoAplicacion(j0);
                    add(j1);
                }
            }
        }
