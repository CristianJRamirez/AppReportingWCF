...
public class VectorSolicitudServicio extends Vector<SolicitudServicio> implements KvmSerializable {
    
    
    public VectorSolicitudServicio(){}
    
    public VectorSolicitudServicio(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    SolicitudServicio j1= new SolicitudServicio(j0);
                    add(j1);
                }
            }
        }
