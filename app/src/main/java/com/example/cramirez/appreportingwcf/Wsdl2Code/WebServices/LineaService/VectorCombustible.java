...
public class VectorCombustible extends Vector<Combustible> implements KvmSerializable {
    
    
    public VectorCombustible(){}
    
    public VectorCombustible(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    Combustible j1= new Combustible(j0);
                    add(j1);
                }
            }
        }
