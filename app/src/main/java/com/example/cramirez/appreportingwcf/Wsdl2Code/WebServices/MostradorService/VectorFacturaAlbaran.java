...
public class VectorFacturaAlbaran extends Vector<FacturaAlbaran> implements KvmSerializable {
    
    
    public VectorFacturaAlbaran(){}
    
    public VectorFacturaAlbaran(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    FacturaAlbaran j1= new FacturaAlbaran(j0);
                    add(j1);
                }
            }
        }
