...
public class VectorHojaDeCampo extends Vector<HojaDeCampo> implements KvmSerializable {
    
    
    public VectorHojaDeCampo(){}
    
    public VectorHojaDeCampo(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    HojaDeCampo j1= new HojaDeCampo(j0);
                    add(j1);
                }
            }
        }
