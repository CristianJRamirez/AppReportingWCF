...
public class QUERY_RegistroExpedientes_Result implements KvmSerializable {
    ...
    public QUERY_RegistroExpedientes_Result(){}
    
    public QUERY_RegistroExpedientes_Result(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
