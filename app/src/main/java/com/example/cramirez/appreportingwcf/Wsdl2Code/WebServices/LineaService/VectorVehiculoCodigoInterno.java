...
public class VectorVehiculoCodigoInterno extends Vector<VehiculoCodigoInterno> implements KvmSerializable {
    
    
    public VectorVehiculoCodigoInterno(){}
    
    public VectorVehiculoCodigoInterno(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    VehiculoCodigoInterno j1= new VehiculoCodigoInterno(j0);
                    add(j1);
                }
            }
        }
