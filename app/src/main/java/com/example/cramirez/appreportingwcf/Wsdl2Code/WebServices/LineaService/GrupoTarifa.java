...
public class GrupoTarifa implements KvmSerializable {
    ...
    public long idGrupoTarifa;
    public boolean idGrupoTarifaSpecified;
    ...
    public GrupoTarifa(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("IdGrupoTarifa"))
        {
            Object obj = soapObject.getProperty("IdGrupoTarifa");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                idGrupoTarifa = Integer.parseInt(j.toString());
            }else if (obj!= null && obj instanceof Number){
                idGrupoTarifa = (Integer) obj;
            }
        }
        if (soapObject.hasProperty("IdGrupoTarifaSpecified"))
        {
            Object obj = soapObject.getProperty("IdGrupoTarifaSpecified");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                idGrupoTarifaSpecified = Boolean.parseBoolean(j.toString());
            }else if (obj!= null && obj instanceof Boolean){
                idGrupoTarifaSpecified = (Boolean) obj;
            }
        }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        switch(index){
            ...
            case 9:
                info.type = Long.class;
                info.name = "IdGrupoTarifa";
                break;
            case 10:
                info.type = PropertyInfo.BOOLEAN_CLASS;
                info.name = "IdGrupoTarifaSpecified";
                break;
            case 11:
                info.type = PropertyInfo.BOOLEAN_CLASS;
                info.name = "Publicado";
