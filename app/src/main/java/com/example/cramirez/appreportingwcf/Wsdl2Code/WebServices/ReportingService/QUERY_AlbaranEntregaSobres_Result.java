...
public class QUERY_AlbaranEntregaSobres_Result implements KvmSerializable {
    ...
    public QUERY_AlbaranEntregaSobres_Result(){}
    
    public QUERY_AlbaranEntregaSobres_Result(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
