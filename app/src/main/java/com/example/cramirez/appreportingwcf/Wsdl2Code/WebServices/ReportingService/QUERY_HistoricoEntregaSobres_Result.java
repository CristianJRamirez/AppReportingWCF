...
public class QUERY_HistoricoEntregaSobres_Result implements KvmSerializable {
    ...
    public QUERY_HistoricoEntregaSobres_Result(){}
    
    public QUERY_HistoricoEntregaSobres_Result(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
