...
public class VectorTipoCuentaContable extends Vector<TipoCuentaContable> implements KvmSerializable {
    
    
    public VectorTipoCuentaContable(){}
    
    public VectorTipoCuentaContable(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    TipoCuentaContable j1= new TipoCuentaContable(j0);
                    add(j1);
                }
            }
        }
