...
public class VectorGrupoImpuesto extends Vector<GrupoImpuesto> implements KvmSerializable {
    
    
    public VectorGrupoImpuesto(){}
    
    public VectorGrupoImpuesto(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    GrupoImpuesto j1= new GrupoImpuesto(j0);
                    add(j1);
                }
            }
        }
