...
public class VectorCategoria_Valor extends Vector<Categoria_Valor> implements KvmSerializable {
    
    
    public VectorCategoria_Valor(){}
    
    public VectorCategoria_Valor(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    Categoria_Valor j1= new Categoria_Valor(j0);
                    add(j1);
                }
            }
        }
