...
public class VectorFichaTecnicaCopiaServicio extends Vector<FichaTecnicaCopiaServicio> implements KvmSerializable {
    ...
    public VectorFichaTecnicaCopiaServicio(){}
    
    public VectorFichaTecnicaCopiaServicio(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    FichaTecnicaCopiaServicio j1= new FichaTecnicaCopiaServicio(j0);
                    add(j1);
                }
            }
        }
