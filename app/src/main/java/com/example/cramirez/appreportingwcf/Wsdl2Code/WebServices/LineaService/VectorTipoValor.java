...
public class VectorTipoValor extends Vector<TipoValor> implements KvmSerializable {
    
    
    public VectorTipoValor(){}
    
    public VectorTipoValor(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
