...
public class VectorVehiculoTipoFicha extends Vector<VehiculoTipoFicha> implements KvmSerializable {
    
    
    public VectorVehiculoTipoFicha(){}
    
    public VectorVehiculoTipoFicha(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    VehiculoTipoFicha j1= new VehiculoTipoFicha(j0);
                    add(j1);
                }
            }
        }
